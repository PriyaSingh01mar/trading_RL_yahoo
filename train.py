...
def Get_data(x):
    ...
    df[:-200].to_csv('train.csv',index=False)
    df[-200:-100].to_csv('val.csv',index=False)
...
if __name__ == "__main__":
    ...
    try:
        main(train_stock, val_stock, window_size, batch_size,
             ep_count, strategy=strategy, model_name=model_name, pretrained=pretrained, debug=debug)
